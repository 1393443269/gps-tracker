...
const routes = [
...

  {
    ...
    children: [
      ...
      { path: 'device-info',     component: () => import('@/views/DeviceInfo.vue'),      meta: { title: '设备信息',  roles: ['admin'] } },
      { path: 'device-settings', component: () => import('@/views/DeviceSettings.vue'), meta: { title: '设备设置',  roles: ['admin'] } },
      { path: 'role-settings',   component: () => import('@/views/RoleSettings.vue'),   meta: { title: '角色设置',  roles: ['admin'] } },
      ...
      { path: 'customers',       component: () => import('@/views/Customer.vue'),        meta: { title: '客户管理',  roles: ['admin'] } },
      ...
      { path: 'platform-setting',component: () => import('@/views/PlatformSetting.vue'),meta: { title: '平台设置',  roles: ['admin'] } },
      { path: 'sims',            component: () => import('@/views/SimCard.vue'),         meta: { title: 'SIM卡管理', roles: ['admin'] } },
      { path: 'recharges',       component: () => import('@/views/Recharge.vue'),        meta: { title: '充值管理',  roles: ['admin'] } },
    ]
  },
]

...
echo "║  管理员账号：admin                                ║"
echo "║  密码：见 .env 的 INIT_ADMIN_PASSWORD             ║"
echo "║       （未设置则为默认 admin123，请尽快改）        ║"
echo "║  808 端口：9090（GPS 设备 TCP 接入）              ║"
echo "╠═══════════════════════════════════════════════════╣"
echo "║  安全组须放行：                                   ║"
echo "║    80/TCP   — HTTP 管理后台                       ║"
echo "║    9090/TCP — GPS 设备接入（JT808/G618G）        ║"
echo "║    1883/TCP — MQTT（走 MQTT 的 G618 设备）        ║"
echo "║    9001/TCP — MQTT over WebSocket                ║"
echo "╚═══════════════════════════════════════════════════╝"
echo ""
echo "常用命令："
